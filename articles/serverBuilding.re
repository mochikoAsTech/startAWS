...
このベースラインですがt2.microだとなんとたったの10%です。普段はCPUを1コアの1/10しか使えない、ということです。そしてサイトにアクセスがわーっと殺到してCPU使用率がベースラインの10%を超えるとバーストモードになり、バーストモードの間だけはCPUが100%使えるようになります。
...
アクセスが殺到していたからCPUを10%以上使っていたわけで、それが急に10%までしか使えなくなってしまったらどうなるのでしょう？バーストが終了した瞬間にもうサイトは応答できなくなります。
