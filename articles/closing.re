...
この章ではAWSを使うのをやめたくなったらしておくべき最後の手続きを紹介します。
...
全然使わない月があったとしてもその分の無料利用枠が翌月以降に繰り越されることはありません。1年経過後、無料利用枠の有効期限が切れると以降は通常の従量課金できっちり請求が来ますので、不要になったインスタンスやサービスは忘れずに削除してください。
